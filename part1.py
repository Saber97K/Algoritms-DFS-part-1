def search_rooms(matrix, current_position, visited_positions, visited_rooms):
    ...
    search_rooms(matrix, (x - 1, y), visited_positions, visited_rooms)  # Up
    search_rooms(matrix, (x + 1, y), visited_positions, visited_rooms)  # Down
    search_rooms(matrix, (x, y - 1), visited_positions, visited_rooms)  # Left
    search_rooms(matrix, (x, y + 1), visited_positions, visited_rooms)  # Right
